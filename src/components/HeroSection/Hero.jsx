    ...
    return (
        <section className="border-1 border-danger pt-24 min-h-screen flex flex-col items-center bg-gradient-to-tr from-black to-gray-900 text-emerald-500 lg:flex-row-reverse lg:py-40 px-6 lg:px-32">
            ...
            <div className=" container mx-auto text-center text-gray-200 ">
                ...
                <h2 className="bg-gradient-to-r from-emerald-500 via-green-400 to-gray-200 text-transparent bg-clip-text text-2xl font-bold mb-8">Desenvolvedor {''}
                    <span className='transition-all duration-500' key={words[currentWordIndex]}> {words[currentWordIndex]} </span>    
                </h2>
                <p className=" tracking-wide leading-relaxed text-emerald-50 text-lg mb-6 max-w-lg mx-auto">Escrevendo código não! Construindo projetos. Da validação de cartões de crédito à criação de experiências com IA, o meu portfólio demonstra o meu entusiasmo por construir a web na prática.</p>
